...
fixture('Login feature testing: Test Scenario 9')
    .page `https://www.saucedemo.com/`;

    /*  Test Scenario 9: Final Order Items
    ...
    Provide user data to checkout products, verifying the products on
    the OverviewPage matches wit the final products on cart */    
test ('Test Scenario 9: Final Order Items - User checkout order completed', async t => {
    /* User Login*/
    ...
    /* Shopping cart, verifying 1 items on cart and match the product selected*/
...
/*  testcafe chrome page_model\test\TestTFinalOrder.js  */ 